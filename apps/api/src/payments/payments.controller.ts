import { Controller, Post, Body, UseGuards, Request, BadRequestException, Get, Param, Res } from '@nestjs/common';
...
export class PaymentsController {
    ...
    @Post('create-order')
    @Post('create-order')
    async createOrder(@Request() req: any, @Body() body: { purpose: 'REGISTRATION' | 'SEAT_BOOKING' | 'MESS_FEE' | 'HOSTEL_FEE' | 'ALLOTMENT_REQUEST' | 'FINE'; fineId?: string }) {
        if (!body.purpose) {
