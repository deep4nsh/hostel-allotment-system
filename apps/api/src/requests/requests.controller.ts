...
export class RequestsController {
    ...
    async updateChangeStatus(@Param('id') id: string, @Body() body: { status: string; comment?: string }) {
    ...
    async updateSurrenderStatus(@Param('id') id: string, @Body() body: { status: string; comment?: string }) {
